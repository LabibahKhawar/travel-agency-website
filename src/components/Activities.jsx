...
export default function Activities() {
  ...
  return (
    <div className="section" style={{ padding: "0 0 20px 0", marginTop: "0px" }}> 
      <div className="container">
        <div className="sectionHeader" style={{ textAlign: "center", marginBottom: "15px" }}> 
          ...
          <p className="sectionSub" style={{ margin: 0, fontSize: '0.9rem' }}>
            Don't just visit, experience the thrill.
          </p>
        </div>
        {blocks.map((block) => (
          block.acts.length > 0 && (
            <div key={block.area} style={{ marginBottom: "15px" }}> 
              
              <div style={{ marginBottom: "5px", borderLeft: "5px solid #0077b6", paddingLeft: "10px" }}> 
